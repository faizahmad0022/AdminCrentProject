  ...
  return (
    <div className="bg-[#F6F7F9] font-sans text-slate-800 ">
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        {/* Top Toaster Alert */}
        {isVisible && (
          <div className="bg-[#FFF5F5] border border-[#FF4D4D] rounded-xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-md transition-all animate-in fade-in slide-in-from-top-2 relative">
            <div className="flex items-center gap-4">
              <div className="bg-[#ED3F3F] rounded-full p-3 shadow-sm">
...
export default CarAlertResponse;