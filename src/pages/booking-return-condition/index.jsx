        ...
        {showToast && (
          <div className="bg-[#FFF5F5] border border-[#FF4D4D] rounded-xl p-4 flex flex-col md:flex-row items-center justify-between gap-4 shadow-md animate-in fade-in slide-in-from-top-2 relative">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-xl font-bold text-slate-900 leading-tight">Return cannot in same condition received</h2>
                <p className="text-sm text-slate-500 font-medium">Vehicle returned in a condition different from when rented</p>
...
export default BookingReturnCondition;