...
const BookingDetails = () => {
    ...
    return (
        <div className="booking-details-page space-y-8">
            <div className="bg-white p-5 rounded-[18px] shadow-[0px_10px_30px_rgba(17,38,146,0.05)] border border-white/60">
                <div className="flex flex-col lg:flex-row items-center gap-6">
                    ...
                    <div className="w-full lg:w-[320px]">
                        <div className="bg-white rounded-[12px] px-4 py-3 flex items-center border border-[#F1F3F9] shadow-sm">
            ...
            <div className="bg-white rounded-[20px] shadow-[0px_10px_30px_rgba(17,38,146,0.05)] border border-white/60 p-6 space-y-6">
                <BookingCard booking={booking} />

                <div className="w-full h-[400px] rounded-[20px] overflow-hidden border border-[#E0E9F4] relative">
                    <iframe
                        title="Booking tracking map"
